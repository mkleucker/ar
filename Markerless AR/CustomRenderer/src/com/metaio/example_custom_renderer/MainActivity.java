...
{
	/**
	 * <code>true</code> if the required native libs are succesfully
	 * loaded in the static section, else <code>false</code>
	 */
	...
	protected void startCamera()
	{
		...
		if (cameras.size() > 0)
		{
			...
			camera.setResolution(new Vector2di(640, 480));		// Capture at 640x480
	...
	final class MetaioSDKCallbackHandler extends IMetaioSDKCallback 
	{
		...
		public void onSDKReady()
		{
			...
			final String trackingConfigFile = AssetsManager.getAssetPath(getApplicationContext(), "TrackingData_MarkerlessFast.xml");
