...
public class TutorialInstantTracking extends ARViewActivity 
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			...
			fis.close();
            String trackingConfigFile = AssetsManager.getAssetPath(getApplicationContext(), "TutorialInstantTracking/Assets/TrackingARzyx.xml");
	...
	final class MetaioSDKCallbackHandler extends IMetaioSDKCallback
	{
		...
		public void onInstantTrackingEvent(boolean success, String file)
		{
			if(success)
			{
				MetaioDebug.log("MetaioSDKCallbackHandler.onInstantTrackingEvent: "+"TrackingARzyx.xml");
